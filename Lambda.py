...
table = dynamodb.Table('BlindSight')
...
def get_help_response():
    ...
    session_attributes = {}
    card_title = "Help"
    speech_output = "BlindSight is an assistant for visually impaired which narrates" \
                    "the description of scene by taking pictures from a camera. " \
                    "It requires raspberry pi and a camera." \
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for trying BlindSight " \
                    "Have a nice day! "
